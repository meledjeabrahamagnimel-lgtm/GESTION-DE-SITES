...
<div>
    <div style="display:grid; grid-template-columns:repeat(4,1fr); gap:14px; margin-bottom:24px;">
        <div style="background:#fff; border:1px solid var(--th-ligne,#E2E0D8); border-radius:10px; padding:16px 18px;">
            <div style="font-size:12.5px; text-transform:uppercase; color:#6B6E76; margin-bottom:6px;">Entreprises</div>
            <div style="font-size:26px; font-weight:800;">{{ $this->stats['entreprises'] }}</div>
            <div style="font-size:13.5px; color:#0E9F6E;">{{ $this->stats['entreprises_actives'] }} actives</div>
        </div>
        <div style="background:#fff; border:1px solid var(--th-ligne,#E2E0D8); border-radius:10px; padding:16px 18px;">
            <div style="font-size:12.5px; text-transform:uppercase; color:#6B6E76; margin-bottom:6px;">Utilisateurs</div>
            <div style="font-size:26px; font-weight:800;">{{ $this->stats['utilisateurs'] }}</div>
        </div>
        <div style="background:#fff; border:1px solid var(--th-ligne,#E2E0D8); border-radius:10px; padding:16px 18px;">
            <div style="font-size:12.5px; text-transform:uppercase; color:#6B6E76; margin-bottom:6px;">Sites</div>
