    ...
    <div style="width:100%; max-width:420px;">
        ...
        <div style="background:#fff; border-radius:12px; padding:24px; box-shadow:0 20px 50px rgba(0,0,0,.35);">
            ...
            <div style="display:flex; align-items:center; gap:10px; margin:18px 0;">
                ...
                <span style="font-size:11px; color:#9A9DA5; text-transform:uppercase; letter-spacing:.04em;">ou</span>
                <div style="flex:1; height:1px; background:#E2E0D8;"></div>
            </div>

            <a href="{{ route('auth.google') }}"
               style="display:flex; align-items:center; justify-content:center; gap:10px; width:100%; box-sizing:border-box; background:#fff; color:#191B20; border:1px solid #E2E0D8; border-radius:8px; padding:10px; font-weight:600; font-size:13.5px; text-decoration:none;">
            ...
            <div style="text-align:center; margin-top:8px;">
                <a href="{{ route('inscription') }}" wire:navigate style="font-size:12.5px; color:#6B6E76; text-decoration:none;">Nouvelle entreprise ? <span style="color:var(--th-accent,#C8102E); font-weight:600;">Créer un compte</span></a>
            </div>
        </div>
    </div>
